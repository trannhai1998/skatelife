...
export default async function Page() {
	...
	const slices = bundleTextAndImage(page.data.slices);
			...
			components={{
				...
				text_and_image_bundle: ({
					...
					<div>
						<SliceZone
							slices={slice?.slices}
							components={components}></SliceZone>
					</div>
				),
			}}
		/>
...
function bundleTextAndImage(slices: Content.HomepageDocumentDataSlicesSlice[]) {
	const res: (
