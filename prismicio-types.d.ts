...
interface SkateboardDocumentData {
  ...
  /**
   * Customize Link field in *Skateboard*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: skateboard.customize_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  customize_link: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
...
interface SkaterDocumentData {
  ...
  /**
   * Customize Link field in *Skater*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.customize_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  customize_link: prismic.LinkField<
...
export interface TextAndImageSliceDefaultPrimary {
   ...
   */
  theme: prismic.SelectField<"Blue" | "Orange" | "Lime" | "Navy">;
}
